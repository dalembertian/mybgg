...
BGG_RETRIES = 10 # previous =  6; default =  3 - Amount of retries before giving up
BGG_DELAY   =  2 # previous =  3; default =  5 - Interval (in seconds) between retries, each time mutlitplying by 1.5
